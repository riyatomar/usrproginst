...
def get_row11(row_2,infoListFinal,wxWordsDictinary,rootWordDictReverse):
    ...
    for concept in row_2:
        for cc_item in (item for item in infoListFinal if item[1] == "CC"):
            ...
            cc_root_word = rootWordDictReverse.get(wxWordsDictinary.get(cc_item[0]))
            # print(cc_root_word)
            if cc_root_word is not None:
                ...
                for value, _ in matching_values:
                    cc_rel_root_word = rootWordDictReverse.get(wxWordsDictinary.get(value[0]))
...
if __name__=="__main__":
    ...
    row_11=get_row11(row_2_result,infoListFinal,wxWordsDictinary,rootWordDictReverse)
